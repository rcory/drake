...
int DoMain() {
  ...
  const auto finger_pp =
      trajectories::PiecewisePolynomial<double>::Pchip(times, finger_keyframes);
  ...
  const auto brick_pp = trajectories::PiecewisePolynomial<double>::Pchip(
  ...
  const auto plant_pp = trajectories::PiecewisePolynomial<double>::Pchip(
