...
DEFINE_double(j1, -0.2, "j1");
DEFINE_double(j2, 0.8, "j2");
...
//  gripper_ics << FLAGS_j1, FLAGS_j2, 0, 0;
  ...
  if (FLAGS_use_brick) {
    ...
    brick_pin.set_angle(&plant_context, M_PI / 4.0);
  }
